...
let top_height = top_buttons[0].offsetHeight;
...
canvas.height = top_height; // Set the height of the canvas to the height of the top buttons
...
let ws_width = window.innerWidth - button_constant
let ws_height = window.innerHeight - top_height